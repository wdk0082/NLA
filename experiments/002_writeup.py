...
CSS = """
:root{--bg:#f3f5f7;--panel:#ffffff;--ink:#1a1f24;--muted:#5b6670;--rule:#d6dce2;--accent:#2f5d9e;--accent-soft:#e4ecf7;--accent-ink:#1e3f6e;--tok:#ffe27a;--tokink:#3d2f00;
...
@media (prefers-color-scheme: dark){:root:not([data-theme="light"]){--bg:#121618;--panel:#1a2024;--ink:#e6ebef;--muted:#9aa6b0;--rule:#2b343b;--accent:#7fb0e8;--accent-soft:#1a2d44;--accent-ink:#bcd5f5;--tok:#6b5a00;--tokink:#fff1b8;--k-orig:#e6ebef;--k-resample:#a3aca9}}
:root[data-theme="dark"]{--bg:#121618;--panel:#1a2024;--ink:#e6ebef;--muted:#9aa6b0;--rule:#2b343b;--accent:#7fb0e8;--accent-soft:#1a2d44;--accent-ink:#bcd5f5;--tok:#6b5a00;--tokink:#fff1b8;--k-orig:#e6ebef;--k-resample:#a3aca9}
...
.panel-h{font-family:"JetBrains Mono",ui-monospace,monospace;font-size:12px;font-weight:600;letter-spacing:.03em;padding:8px 12px;border-bottom:1px solid var(--rule);background:var(--bg)}
