...
- Results in `experiments/results/exp_002_r3/` (summary.json, whole_effects.csv, alignment.csv, variants / recon_index / output / nli_variants / nli_x_whole CSVs, PNG plots, config); hand edits in `configs/hand_edits_exp002_r3.jsonl` (+ parts); walkthrough `experiments/results/exp_002_r3_walkthrough.html` (idx 79).
